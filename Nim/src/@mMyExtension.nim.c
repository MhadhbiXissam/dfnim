...
typedef N_CDECL_PTR(int, tyProc__vdR7rybsKMsOGVgx9brurTw) (lua_State* L_p0);
typedef luaL_Reg tyArray__QYECJbuyiu0pRiaLO1Xdaw[2];
...
N_LIB_EXPORT N_CDECL(void, LuaInit)(lua_State* L_p0) {
	tyArray__QYECJbuyiu0pRiaLO1Xdaw regs;
	luaL_Reg T1_;
	luaL_Reg T2_;
	echoBinSafe(TM__P0bMNVFNT0YdpMgVGanZwg_4, 1);
	nimZeroMem((void*)regs, sizeof(tyArray__QYECJbuyiu0pRiaLO1Xdaw));
